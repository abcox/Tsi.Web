...
namespace Tsi.Web.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        // IdeaNetworks data (for test)
        public const string apiPrivateKey = "9929a6a8-f3a5-4234-84f4-05e43b90e51c";
        public const string apiPublicKey = "bd3bb288-4752-44a2-b904-dffd30563c0f";
        public const int TestAccountNumber = 10177; // "Barker, Hayden  (Personal)"
        public const string TestAccountName = "Barker, Hayden  (Personal)"; // AccountNumber = 10177;
        ...
        public Configuration()
        {
            ...
            BasePath = "http://api2.tigerpawsoftware.com";
        ...
        public Configuration(
            ...
            string basePath = "http://api2.tigerpawsoftware.com") : this()
        {
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 18.2.1\n";
