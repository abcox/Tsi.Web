...
{
    /// <summary>
    /// TsiWebAccountProfile
    /// </summary>
    [DataContract]
    public partial class TsiWebAccountProfile :  IEquatable<TsiWebAccountProfile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebAccountProfile" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebAccountProfile(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebAccountProfile {\n");
        ...
        {
            return this.Equals(input as TsiWebAccountProfile);
        }

        /// <summary>
        /// Returns true if TsiWebAccountProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebAccountProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebAccountProfile input)
        {
            if (input == null)
                return false;
