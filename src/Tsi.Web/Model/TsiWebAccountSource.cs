...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebAccountSource :  IEquatable<TsiWebAccountSource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebAccountSource" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebAccountSource(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebAccountSource {\n");
        ...
        {
            return this.Equals(input as TsiWebAccountSource);
        }

        /// <summary>
        /// Returns true if TsiWebAccountSource instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebAccountSource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebAccountSource input)
        {
            if (input == null)
                return false;
