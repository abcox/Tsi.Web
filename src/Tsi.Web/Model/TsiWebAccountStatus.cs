...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebAccountStatus :  IEquatable<TsiWebAccountStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebAccountStatus" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebAccountStatus(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebAccountStatus {\n");
        ...
        {
            return this.Equals(input as TsiWebAccountStatus);
        }

        /// <summary>
        /// Returns true if TsiWebAccountStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebAccountStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebAccountStatus input)
        {
            if (input == null)
                return false;
