...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebAccountType :  IEquatable<TsiWebAccountType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebAccountType" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebAccountType(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebAccountType {\n");
        ...
        {
            return this.Equals(input as TsiWebAccountType);
        }

        /// <summary>
        /// Returns true if TsiWebAccountType instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebAccountType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebAccountType input)
        {
            if (input == null)
                return false;
