...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebBOTaxType :  IEquatable<TsiWebBOTaxType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebBOTaxType" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebBOTaxType(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebBOTaxType {\n");
        ...
        {
            return this.Equals(input as TsiWebBOTaxType);
        }

        /// <summary>
        /// Returns true if TsiWebBOTaxType instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebBOTaxType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebBOTaxType input)
        {
            if (input == null)
                return false;
