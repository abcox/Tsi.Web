...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebBillTo :  IEquatable<TsiWebBillTo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebBillTo" /> class.
        /// </summary>
        ...
        public TsiWebBillTo(int? billToId = default(int?), string aRCustomerNumber = default(string), bool? isPrimary = default(bool?), string name = default(string), string address1 = default(string), string address2 = default(string), string city = default(string), string state = default(string), string postalCode = default(string), string country = default(string), string contactName = default(string), string contactPhone = default(string))
        {
        ...
        {
            return this.Equals(input as TsiWebBillTo);
        }

        /// <summary>
        /// Returns true if TsiWebBillTo instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebBillTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebBillTo input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.BillToId == input.BillToId ||
                    (this.BillToId != null &&
                    this.BillToId.Equals(input.BillToId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BillToId != null)
                    hashCode = hashCode * 59 + this.BillToId.GetHashCode();
