...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebCloseReason :  IEquatable<TsiWebCloseReason>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebCloseReason" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebCloseReason(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebCloseReason {\n");
        ...
        {
            return this.Equals(input as TsiWebCloseReason);
        }

        /// <summary>
        /// Returns true if TsiWebCloseReason instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebCloseReason to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebCloseReason input)
        {
            if (input == null)
                return false;
