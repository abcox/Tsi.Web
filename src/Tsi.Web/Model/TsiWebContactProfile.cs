...
{
    /// <summary>
    /// TsiWebContactProfile
    /// </summary>
    [DataContract]
    public partial class TsiWebContactProfile :  IEquatable<TsiWebContactProfile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebContactProfile" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebContactProfile(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebContactProfile {\n");
        ...
        {
            return this.Equals(input as TsiWebContactProfile);
        }

        /// <summary>
        /// Returns true if TsiWebContactProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebContactProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebContactProfile input)
        {
            if (input == null)
                return false;
