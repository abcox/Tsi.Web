...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebCountry :  IEquatable<TsiWebCountry>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebCountry" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebCountry(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        {
            return this.Equals(input as TsiWebCountry);
        }

        /// <summary>
        /// Returns true if TsiWebCountry instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebCountry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebCountry input)
        {
            if (input == null)
                return false;
