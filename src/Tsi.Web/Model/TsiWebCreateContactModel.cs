...
{
    /// <summary>
    /// TsiWebCreateContactModel
    /// </summary>
    [DataContract]
    public partial class TsiWebCreateContactModel :  IEquatable<TsiWebCreateContactModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebCreateContactModel" /> class.
        /// </summary>
        /// <param name="contact">contact.</param>
        /// <param name="primaryPhoneNumber">primaryPhoneNumber.</param>
        /// <param name="primaryEmailAddress">primaryEmailAddress.</param>
        public TsiWebCreateContactModel(TsiWebContact contact = default(TsiWebContact), TsiWebPhoneNumber primaryPhoneNumber = default(TsiWebPhoneNumber), TsiWebEmailAddress primaryEmailAddress = default(TsiWebEmailAddress))
        {
        ...
        public TsiWebEmailAddress PrimaryEmailAddress { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebCreateContactModel {\n");
        ...
        {
            return this.Equals(input as TsiWebCreateContactModel);
        }

        /// <summary>
        /// Returns true if TsiWebCreateContactModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebCreateContactModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebCreateContactModel input)
        {
            if (input == null)
                return false;
