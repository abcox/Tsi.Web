...
{
    /// <summary>
    /// TsiWebCreateQuoteDetailItemModel
    /// </summary>
    [DataContract]
    public partial class TsiWebCreateQuoteDetailItemModel :  IEquatable<TsiWebCreateQuoteDetailItemModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebCreateQuoteDetailItemModel" /> class.
        /// </summary>
        ...
        public TsiWebCreateQuoteDetailItemModel(int? lineNumber = default(int?), int? projectPhaseNumber = default(int?), int? priceBookItemNumber = default(int?), string itemId = default(string), string itemDescription = default(string), int? priceLevel = default(int?), string installLocation = default(string), string priceAdjuster = default(string), DateTime? orderByDate = default(DateTime?), bool? taxable = default(bool?), bool? subjectToProviderTax = default(bool?), bool? printOnInvoice = default(bool?), bool? printOnQuote = default(bool?), bool? itemCanBeDiscounted = default(bool?), bool? useThisCostWhenOrdering = default(bool?), bool? useBookPricesAndDiscounts = default(bool?), bool? calculateUsingAdjustedDiscountPercent = default(bool?), bool? allowPriceLessThanCost = default(bool?), bool? canAdjustToMaxDiscount = default(bool?), double? adjustedSellingPrice = default(double?), double? estimatedCost = default(double?), double? adjustedDiscountPercent = default(double?), double? quantity = default(double?), List<TsiWebQuoteAssemblyDetailAdjustment> openAssemblyAdjustments = default(List<TsiWebQuoteAssemblyDetailAdjustment>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebCreateQuoteDetailItemModel {\n");
        ...
        {
            return this.Equals(input as TsiWebCreateQuoteDetailItemModel);
        }

        /// <summary>
        /// Returns true if TsiWebCreateQuoteDetailItemModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebCreateQuoteDetailItemModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebCreateQuoteDetailItemModel input)
        {
            if (input == null)
                return false;
