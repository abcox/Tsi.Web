...
{
    /// <summary>
    /// TsiWebCreateServiceOrderNonStockModel
    /// </summary>
    [DataContract]
    public partial class TsiWebCreateServiceOrderNonStockModel :  IEquatable<TsiWebCreateServiceOrderNonStockModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebCreateServiceOrderNonStockModel" /> class.
        /// </summary>
        ...
        public TsiWebCreateServiceOrderNonStockModel(string itemId = default(string), string type = default(string), int? lineNumber = default(int?), string itemDescription = default(string), bool? taxable = default(bool?), bool? subjectToProviderTax = default(bool?), bool? subjectToSingleItemTax = default(bool?), bool? isSerialized = default(bool?), bool? printOnInvoice = default(bool?), bool? underContract = default(bool?), double? manufacturerListPrice = default(double?), double? sellingPrice = default(double?), double? cost = default(double?), bool? useThisCostWhenOrdering = default(bool?), double? quantity = default(double?), int? serviceOrderItemsServicedNumber = default(int?), string memo = default(string), SystemNullableTsiWebOptionalDateTime orderByDate = default(SystemNullableTsiWebOptionalDateTime), int? projectPhaseNumber = default(int?), string installLocation = default(string), bool? allowPriceLessThanCost = default(bool?))
        {
            this.ItemId = itemId;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebCreateServiceOrderNonStockModel {\n");
        ...
        {
            return this.Equals(input as TsiWebCreateServiceOrderNonStockModel);
        }

        /// <summary>
        /// Returns true if TsiWebCreateServiceOrderNonStockModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebCreateServiceOrderNonStockModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebCreateServiceOrderNonStockModel input)
        {
            if (input == null)
                return false;
