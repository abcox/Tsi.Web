...
{
    /// <summary>
    /// TsiWebCreateServiceOrderTimeLogModel
    /// </summary>
    [DataContract]
    public partial class TsiWebCreateServiceOrderTimeLogModel :  IEquatable<TsiWebCreateServiceOrderTimeLogModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebCreateServiceOrderTimeLogModel" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebCreateServiceOrderTimeLogModel {\n");
        ...
        {
            return this.Equals(input as TsiWebCreateServiceOrderTimeLogModel);
        }

        /// <summary>
        /// Returns true if TsiWebCreateServiceOrderTimeLogModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebCreateServiceOrderTimeLogModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebCreateServiceOrderTimeLogModel input)
        {
            if (input == null)
                return false;
