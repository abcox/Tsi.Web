...
{
    /// <summary>
    /// TsiWebCreateTimeEntryReasonRequest
    /// </summary>
    [DataContract]
    public partial class TsiWebCreateTimeEntryReasonRequest :  IEquatable<TsiWebCreateTimeEntryReasonRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebCreateTimeEntryReasonRequest" /> class.
        /// </summary>
        ...
        public TsiWebCreateTimeEntryReasonRequest(TsiWebTimeEntryReason timeEntry = default(TsiWebTimeEntryReason), string rateBasis = default(string), string billingOption = default(string), bool? useStandardRate = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebCreateTimeEntryReasonRequest {\n");
        ...
        {
            return this.Equals(input as TsiWebCreateTimeEntryReasonRequest);
        }

        /// <summary>
        /// Returns true if TsiWebCreateTimeEntryReasonRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebCreateTimeEntryReasonRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebCreateTimeEntryReasonRequest input)
        {
            if (input == null)
                return false;
