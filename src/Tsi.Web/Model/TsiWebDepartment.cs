...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebDepartment :  IEquatable<TsiWebDepartment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebDepartment" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebDepartment(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebDepartment {\n");
        ...
        {
            return this.Equals(input as TsiWebDepartment);
        }

        /// <summary>
        /// Returns true if TsiWebDepartment instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebDepartment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebDepartment input)
        {
            if (input == null)
                return false;
