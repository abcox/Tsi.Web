...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebDocumentTopic :  IEquatable<TsiWebDocumentTopic>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebDocumentTopic" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebDocumentTopic(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebDocumentTopic {\n");
        ...
        {
            return this.Equals(input as TsiWebDocumentTopic);
        }

        /// <summary>
        /// Returns true if TsiWebDocumentTopic instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebDocumentTopic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebDocumentTopic input)
        {
            if (input == null)
                return false;
