...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebFreightTerm :  IEquatable<TsiWebFreightTerm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebFreightTerm" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebFreightTerm(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebFreightTerm {\n");
        ...
        {
            return this.Equals(input as TsiWebFreightTerm);
        }

        /// <summary>
        /// Returns true if TsiWebFreightTerm instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebFreightTerm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebFreightTerm input)
        {
            if (input == null)
                return false;
