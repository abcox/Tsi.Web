...
{
    /// <summary>
    /// TsiWebHowDidYouHearAboutUs
    /// </summary>
    [DataContract]
    public partial class TsiWebHowDidYouHearAboutUs :  IEquatable<TsiWebHowDidYouHearAboutUs>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebHowDidYouHearAboutUs" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebHowDidYouHearAboutUs(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebHowDidYouHearAboutUs {\n");
        ...
        {
            return this.Equals(input as TsiWebHowDidYouHearAboutUs);
        }

        /// <summary>
        /// Returns true if TsiWebHowDidYouHearAboutUs instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebHowDidYouHearAboutUs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebHowDidYouHearAboutUs input)
        {
            if (input == null)
                return false;
