...
{
    /// <summary>
    /// TsiWebMasterTableEntry
    /// </summary>
    [DataContract]
    public partial class TsiWebMasterTableEntry :  IEquatable<TsiWebMasterTableEntry>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebMasterTableEntry" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebMasterTableEntry(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebMasterTableEntry {\n");
        ...
        {
            return this.Equals(input as TsiWebMasterTableEntry);
        }

        /// <summary>
        /// Returns true if TsiWebMasterTableEntry instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebMasterTableEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebMasterTableEntry input)
        {
            if (input == null)
                return false;
