...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebMeter :  IEquatable<TsiWebMeter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebMeter" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebMeter(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        {
            return this.Equals(input as TsiWebMeter);
        }

        /// <summary>
        /// Returns true if TsiWebMeter instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebMeter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebMeter input)
        {
            if (input == null)
                return false;
