...
{
    /// <summary>
    /// TsiWebNextActionType
    /// </summary>
    [DataContract]
    public partial class TsiWebNextActionType :  IEquatable<TsiWebNextActionType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebNextActionType" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebNextActionType(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebNextActionType {\n");
        ...
        {
            return this.Equals(input as TsiWebNextActionType);
        }

        /// <summary>
        /// Returns true if TsiWebNextActionType instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebNextActionType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebNextActionType input)
        {
            if (input == null)
                return false;
