...
{
    /// <summary>
    /// TsiWebOpportunityStageSummary
    /// </summary>
    [DataContract]
    public partial class TsiWebOpportunityStageSummary :  IEquatable<TsiWebOpportunityStageSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebOpportunityStageSummary" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebOpportunityStageSummary {\n");
        ...
        {
            return this.Equals(input as TsiWebOpportunityStageSummary);
        }

        /// <summary>
        /// Returns true if TsiWebOpportunityStageSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebOpportunityStageSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebOpportunityStageSummary input)
        {
            if (input == null)
                return false;
