...
{
    /// <summary>
    /// TsiWebOpportunityType
    /// </summary>
    [DataContract]
    public partial class TsiWebOpportunityType :  IEquatable<TsiWebOpportunityType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebOpportunityType" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebOpportunityType(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebOpportunityType {\n");
        ...
        {
            return this.Equals(input as TsiWebOpportunityType);
        }

        /// <summary>
        /// Returns true if TsiWebOpportunityType instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebOpportunityType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebOpportunityType input)
        {
            if (input == null)
                return false;
