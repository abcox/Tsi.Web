...
{
    /// <summary>
    /// TsiWebPasswordCategory
    /// </summary>
    [DataContract]
    public partial class TsiWebPasswordCategory :  IEquatable<TsiWebPasswordCategory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebPasswordCategory" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebPasswordCategory(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebPasswordCategory {\n");
        ...
        {
            return this.Equals(input as TsiWebPasswordCategory);
        }

        /// <summary>
        /// Returns true if TsiWebPasswordCategory instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebPasswordCategory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebPasswordCategory input)
        {
            if (input == null)
                return false;
