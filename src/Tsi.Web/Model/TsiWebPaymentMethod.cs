...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebPaymentMethod :  IEquatable<TsiWebPaymentMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebPaymentMethod" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebPaymentMethod(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebPaymentMethod {\n");
        ...
        {
            return this.Equals(input as TsiWebPaymentMethod);
        }

        /// <summary>
        /// Returns true if TsiWebPaymentMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebPaymentMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebPaymentMethod input)
        {
            if (input == null)
                return false;
