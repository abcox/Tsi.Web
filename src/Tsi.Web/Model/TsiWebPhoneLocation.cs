...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebPhoneLocation :  IEquatable<TsiWebPhoneLocation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebPhoneLocation" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebPhoneLocation(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebPhoneLocation {\n");
        ...
        {
            return this.Equals(input as TsiWebPhoneLocation);
        }

        /// <summary>
        /// Returns true if TsiWebPhoneLocation instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebPhoneLocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebPhoneLocation input)
        {
            if (input == null)
                return false;
