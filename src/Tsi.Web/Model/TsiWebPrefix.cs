...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebPrefix :  IEquatable<TsiWebPrefix>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebPrefix" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebPrefix(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        {
            return this.Equals(input as TsiWebPrefix);
        }

        /// <summary>
        /// Returns true if TsiWebPrefix instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebPrefix to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebPrefix input)
        {
            if (input == null)
                return false;
