...
{
    /// <summary>
    /// TsiWebPurchaseOrderDescription
    /// </summary>
    [DataContract]
    public partial class TsiWebPurchaseOrderDescription :  IEquatable<TsiWebPurchaseOrderDescription>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebPurchaseOrderDescription" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebPurchaseOrderDescription(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebPurchaseOrderDescription {\n");
        ...
        {
            return this.Equals(input as TsiWebPurchaseOrderDescription);
        }

        /// <summary>
        /// Returns true if TsiWebPurchaseOrderDescription instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebPurchaseOrderDescription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebPurchaseOrderDescription input)
        {
            if (input == null)
                return false;
