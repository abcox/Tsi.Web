...
{
    /// <summary>
    /// TsiWebRecurringServiceOrderSchedule
    /// </summary>
    [DataContract]
    public partial class TsiWebRecurringServiceOrderSchedule :  IEquatable<TsiWebRecurringServiceOrderSchedule>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebRecurringServiceOrderSchedule" /> class.
        /// </summary>
        /// <param name="recurringServiceOrderScheduleId">recurringServiceOrderScheduleId.</param>
        ...
        /// <param name="numberOfServiceOrdersCreated">numberOfServiceOrdersCreated.</param>
        /// <param name="dateOfLastServiceOrderCreated">dateOfLastServiceOrderCreated.</param>
        /// <param name="firstServiceOrderNumber">firstServiceOrderNumber.</param>
        /// <param name="sequenceCompleted">sequenceCompleted.</param>
        public TsiWebRecurringServiceOrderSchedule(int? recurringServiceOrderScheduleId = default(int?), string recurringScheduleName = default(string), int? templateId = default(int?), string templateName = default(string), int? accountNumber = default(int?), DateTime? startDate = default(DateTime?), int? takenByRepNumber = default(int?), int? createAheadDays = default(int?), DateTime? serviceOrderReceivedTime = default(DateTime?), DateTime? endByDate = default(DateTime?), int? numberOfOccurences = default(int?), string frequency = default(string), int? dailyInterval = default(int?), bool? scheduleEveryWeekday = default(bool?), int? weeklyInterval = default(int?), bool? weeklyOnSunday = default(bool?), bool? weeklyOnMonday = default(bool?), bool? weeklyOnTuesday = default(bool?), bool? weeklyOnWednesday = default(bool?), bool? weeklyOnThursday = default(bool?), bool? weeklyOnFriday = default(bool?), bool? weeklyOnSaturday = default(bool?), int? monthlyInterval = default(int?), int? dayOfMonth = default(int?), string weekOfMonth = default(string), string dayOfWeek = default(string), int? yearlyInterval = default(int?), int? monthOfYear = default(int?), int? numberOfServiceOrdersCreated = default(int?), DateTime? dateOfLastServiceOrderCreated = default(DateTime?), int? firstServiceOrderNumber = default(int?), bool? sequenceCompleted = default(bool?))
        {
            this.RecurringServiceOrderScheduleId = recurringServiceOrderScheduleId;
            ...
            this.NumberOfServiceOrdersCreated = numberOfServiceOrdersCreated;
            this.DateOfLastServiceOrderCreated = dateOfLastServiceOrderCreated;
            this.FirstServiceOrderNumber = firstServiceOrderNumber;
            this.SequenceCompleted = sequenceCompleted;
        }
        
        /// <summary>
        /// Gets or Sets RecurringServiceOrderScheduleId
        /// </summary>
        [DataMember(Name="RecurringServiceOrderScheduleId", EmitDefaultValue=false)]
        public int? RecurringServiceOrderScheduleId { get; set; }
        ...
        /// <summary>
        /// Gets or Sets NumberOfServiceOrdersCreated
        /// </summary>
        [DataMember(Name="NumberOfServiceOrdersCreated", EmitDefaultValue=false)]
        public int? NumberOfServiceOrdersCreated { get; set; }

        /// <summary>
        /// Gets or Sets DateOfLastServiceOrderCreated
        /// </summary>
        [DataMember(Name="DateOfLastServiceOrderCreated", EmitDefaultValue=false)]
        public DateTime? DateOfLastServiceOrderCreated { get; set; }

        /// <summary>
        /// Gets or Sets FirstServiceOrderNumber
        /// </summary>
        [DataMember(Name="FirstServiceOrderNumber", EmitDefaultValue=false)]
        public int? FirstServiceOrderNumber { get; set; }

        /// <summary>
        /// Gets or Sets SequenceCompleted
        /// </summary>
        [DataMember(Name="SequenceCompleted", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebRecurringServiceOrderSchedule {\n");
            sb.Append("  RecurringServiceOrderScheduleId: ").Append(RecurringServiceOrderScheduleId).Append("\n");
            ...
            sb.Append("  NumberOfServiceOrdersCreated: ").Append(NumberOfServiceOrdersCreated).Append("\n");
            sb.Append("  DateOfLastServiceOrderCreated: ").Append(DateOfLastServiceOrderCreated).Append("\n");
            sb.Append("  FirstServiceOrderNumber: ").Append(FirstServiceOrderNumber).Append("\n");
            sb.Append("  SequenceCompleted: ").Append(SequenceCompleted).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TsiWebRecurringServiceOrderSchedule);
        }

        /// <summary>
        /// Returns true if TsiWebRecurringServiceOrderSchedule instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebRecurringServiceOrderSchedule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebRecurringServiceOrderSchedule input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.RecurringServiceOrderScheduleId == input.RecurringServiceOrderScheduleId ||
                    (this.RecurringServiceOrderScheduleId != null &&
                    this.RecurringServiceOrderScheduleId.Equals(input.RecurringServiceOrderScheduleId))
                ) && 
                (
                ...
                (
                    this.NumberOfServiceOrdersCreated == input.NumberOfServiceOrdersCreated ||
                    (this.NumberOfServiceOrdersCreated != null &&
                    this.NumberOfServiceOrdersCreated.Equals(input.NumberOfServiceOrdersCreated))
                ) && 
                (
                    this.DateOfLastServiceOrderCreated == input.DateOfLastServiceOrderCreated ||
                    (this.DateOfLastServiceOrderCreated != null &&
                    this.DateOfLastServiceOrderCreated.Equals(input.DateOfLastServiceOrderCreated))
                ) && 
                (
                    this.FirstServiceOrderNumber == input.FirstServiceOrderNumber ||
                    (this.FirstServiceOrderNumber != null &&
                    this.FirstServiceOrderNumber.Equals(input.FirstServiceOrderNumber))
                ) && 
                (
                    this.SequenceCompleted == input.SequenceCompleted ||
                    (this.SequenceCompleted != null &&
                    this.SequenceCompleted.Equals(input.SequenceCompleted))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.RecurringServiceOrderScheduleId != null)
                    hashCode = hashCode * 59 + this.RecurringServiceOrderScheduleId.GetHashCode();
                ...
                if (this.NumberOfServiceOrdersCreated != null)
                    hashCode = hashCode * 59 + this.NumberOfServiceOrdersCreated.GetHashCode();
                if (this.DateOfLastServiceOrderCreated != null)
                    hashCode = hashCode * 59 + this.DateOfLastServiceOrderCreated.GetHashCode();
                if (this.FirstServiceOrderNumber != null)
                    hashCode = hashCode * 59 + this.FirstServiceOrderNumber.GetHashCode();
                if (this.SequenceCompleted != null)
                    hashCode = hashCode * 59 + this.SequenceCompleted.GetHashCode();
                return hashCode;
            }
        }
