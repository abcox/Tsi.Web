...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebRepDetail :  IEquatable<TsiWebRepDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebRepDetail" /> class.
        /// </summary>
        ...
        /// <param name="repPreferences">repPreferences.</param>
        ...
        public TsiWebRepDetail(int? repNumber = default(int?), int? personalAccountNumber = default(int?), TsiWebAddress address = default(TsiWebAddress), string homePhone = default(string), string mobilePhone = default(string), string status = default(string), bool? inactive = default(bool?), TsiWebRepPreferences repPreferences = default(TsiWebRepPreferences), string firstName = default(string), string lastName = default(string), string phoneNumber = default(string), string emailAddress = default(string), string title = default(string), string displayName = default(string), string searchName = default(string))
        {
            ...
            this.RepPreferences = repPreferences;
        ...
        /// <summary>
        /// Gets or Sets RepPreferences
        /// </summary>
        [DataMember(Name="RepPreferences", EmitDefaultValue=false)]
        public TsiWebRepPreferences RepPreferences { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebRepDetail {\n");
            ...
            sb.Append("  RepPreferences: ").Append(RepPreferences).Append("\n");
        ...
        {
            return this.Equals(input as TsiWebRepDetail);
        }

        /// <summary>
        /// Returns true if TsiWebRepDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebRepDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebRepDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RepPreferences == input.RepPreferences ||
                    (this.RepPreferences != null &&
                    this.RepPreferences.Equals(input.RepPreferences))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RepPreferences != null)
                    hashCode = hashCode * 59 + this.RepPreferences.GetHashCode();
