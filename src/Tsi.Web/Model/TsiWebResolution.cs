...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebResolution :  IEquatable<TsiWebResolution>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebResolution" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebResolution(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebResolution {\n");
        ...
        {
            return this.Equals(input as TsiWebResolution);
        }

        /// <summary>
        /// Returns true if TsiWebResolution instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebResolution to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebResolution input)
        {
            if (input == null)
                return false;
