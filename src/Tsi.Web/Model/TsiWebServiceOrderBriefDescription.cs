...
{
    /// <summary>
    /// TsiWebServiceOrderBriefDescription
    /// </summary>
    [DataContract]
    public partial class TsiWebServiceOrderBriefDescription :  IEquatable<TsiWebServiceOrderBriefDescription>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebServiceOrderBriefDescription" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebServiceOrderBriefDescription(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebServiceOrderBriefDescription {\n");
        ...
        {
            return this.Equals(input as TsiWebServiceOrderBriefDescription);
        }

        /// <summary>
        /// Returns true if TsiWebServiceOrderBriefDescription instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebServiceOrderBriefDescription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebServiceOrderBriefDescription input)
        {
            if (input == null)
                return false;
