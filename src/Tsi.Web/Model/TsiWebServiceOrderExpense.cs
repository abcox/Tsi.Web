...
{
    /// <summary>
    /// TsiWebServiceOrderExpense
    /// </summary>
    [DataContract]
    public partial class TsiWebServiceOrderExpense :  IEquatable<TsiWebServiceOrderExpense>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebServiceOrderExpense" /> class.
        /// </summary>
        ...
        public TsiWebServiceOrderExpense(int? expenseNumber = default(int?), double? expenseAmount = default(double?), int? repNumber = default(int?), string repName = default(string), string comments = default(string), bool? billable = default(bool?), double? odometerStart = default(double?), double? odometerEnd = default(double?), double? distance = default(double?), int? expenseTypeNumber = default(int?), string expenseTypeDescription = default(string), string acceptanceStatus = default(string), string rejectedReason = default(string), int? reviewedBy = default(int?), string reviewedByName = default(string), bool? reimbursable = default(bool?), DateTime? expenseDateTime = default(DateTime?), int? expensePaymentTypeNumber = default(int?), DateTime? dateCreated = default(DateTime?), string expensePaymentDescription = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebServiceOrderExpense {\n");
        ...
        {
            return this.Equals(input as TsiWebServiceOrderExpense);
        }

        /// <summary>
        /// Returns true if TsiWebServiceOrderExpense instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebServiceOrderExpense to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebServiceOrderExpense input)
        {
            if (input == null)
                return false;
