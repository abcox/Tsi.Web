...
{
    /// <summary>
    /// TsiWebServiceOrderNoteTopic
    /// </summary>
    [DataContract]
    public partial class TsiWebServiceOrderNoteTopic :  IEquatable<TsiWebServiceOrderNoteTopic>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebServiceOrderNoteTopic" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebServiceOrderNoteTopic(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebServiceOrderNoteTopic {\n");
        ...
        {
            return this.Equals(input as TsiWebServiceOrderNoteTopic);
        }

        /// <summary>
        /// Returns true if TsiWebServiceOrderNoteTopic instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebServiceOrderNoteTopic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebServiceOrderNoteTopic input)
        {
            if (input == null)
                return false;
