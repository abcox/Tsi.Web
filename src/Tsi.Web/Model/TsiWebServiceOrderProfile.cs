...
{
    /// <summary>
    /// TsiWebServiceOrderProfile
    /// </summary>
    [DataContract]
    public partial class TsiWebServiceOrderProfile :  IEquatable<TsiWebServiceOrderProfile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebServiceOrderProfile" /> class.
        /// </summary>
        ...
        public TsiWebServiceOrderProfile(string profile = default(string), int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebServiceOrderProfile {\n");
        ...
        {
            return this.Equals(input as TsiWebServiceOrderProfile);
        }

        /// <summary>
        /// Returns true if TsiWebServiceOrderProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebServiceOrderProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebServiceOrderProfile input)
        {
            if (input == null)
                return false;
