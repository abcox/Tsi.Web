...
{
    /// <summary>
    /// TsiWebServiceOrderTemplatePartAssemblyDetail
    /// </summary>
    [DataContract]
    public partial class TsiWebServiceOrderTemplatePartAssemblyDetail :  IEquatable<TsiWebServiceOrderTemplatePartAssemblyDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebServiceOrderTemplatePartAssemblyDetail" /> class.
        /// </summary>
        /// <param name="serviceOrderTemplatePartAssemblyDetailNumber">serviceOrderTemplatePartAssemblyDetailNumber.</param>
        ...
        public TsiWebServiceOrderTemplatePartAssemblyDetail(int? serviceOrderTemplatePartAssemblyDetailNumber = default(int?), int? sequenceNumber = default(int?), string itemID = default(string), string itemDescription = default(string), double? quantity = default(double?), string pricingMethod = default(string), double? fixedPrice = default(double?), int? priceLevel = default(int?), string priceLevelDescription = default(string), string type = default(string), string itemNotes = default(string), bool? printOnInvoice = default(bool?))
        {
            this.ServiceOrderTemplatePartAssemblyDetailNumber = serviceOrderTemplatePartAssemblyDetailNumber;
        ...
        /// <summary>
        /// Gets or Sets ServiceOrderTemplatePartAssemblyDetailNumber
        /// </summary>
        [DataMember(Name="ServiceOrderTemplatePartAssemblyDetailNumber", EmitDefaultValue=false)]
        public int? ServiceOrderTemplatePartAssemblyDetailNumber { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebServiceOrderTemplatePartAssemblyDetail {\n");
            sb.Append("  ServiceOrderTemplatePartAssemblyDetailNumber: ").Append(ServiceOrderTemplatePartAssemblyDetailNumber).Append("\n");
        ...
        {
            return this.Equals(input as TsiWebServiceOrderTemplatePartAssemblyDetail);
        }

        /// <summary>
        /// Returns true if TsiWebServiceOrderTemplatePartAssemblyDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebServiceOrderTemplatePartAssemblyDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebServiceOrderTemplatePartAssemblyDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ServiceOrderTemplatePartAssemblyDetailNumber == input.ServiceOrderTemplatePartAssemblyDetailNumber ||
                    (this.ServiceOrderTemplatePartAssemblyDetailNumber != null &&
                    this.ServiceOrderTemplatePartAssemblyDetailNumber.Equals(input.ServiceOrderTemplatePartAssemblyDetailNumber))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ServiceOrderTemplatePartAssemblyDetailNumber != null)
                    hashCode = hashCode * 59 + this.ServiceOrderTemplatePartAssemblyDetailNumber.GetHashCode();
