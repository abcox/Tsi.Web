...
{
    /// <summary>
    /// TsiWebServiceOrderTimeLog
    /// </summary>
    [DataContract]
    public partial class TsiWebServiceOrderTimeLog :  IEquatable<TsiWebServiceOrderTimeLog>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebServiceOrderTimeLog" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebServiceOrderTimeLog {\n");
        ...
        {
            return this.Equals(input as TsiWebServiceOrderTimeLog);
        }

        /// <summary>
        /// Returns true if TsiWebServiceOrderTimeLog instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebServiceOrderTimeLog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebServiceOrderTimeLog input)
        {
            if (input == null)
                return false;
