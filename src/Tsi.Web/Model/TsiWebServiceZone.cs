...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebServiceZone :  IEquatable<TsiWebServiceZone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebServiceZone" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebServiceZone(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebServiceZone {\n");
        ...
        {
            return this.Equals(input as TsiWebServiceZone);
        }

        /// <summary>
        /// Returns true if TsiWebServiceZone instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebServiceZone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebServiceZone input)
        {
            if (input == null)
                return false;
