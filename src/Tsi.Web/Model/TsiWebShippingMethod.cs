...
{
    /// <summary>
    /// TsiWebShippingMethod
    /// </summary>
    [DataContract]
    public partial class TsiWebShippingMethod :  IEquatable<TsiWebShippingMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebShippingMethod" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebShippingMethod(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebShippingMethod {\n");
        ...
        {
            return this.Equals(input as TsiWebShippingMethod);
        }

        /// <summary>
        /// Returns true if TsiWebShippingMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebShippingMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebShippingMethod input)
        {
            if (input == null)
                return false;
