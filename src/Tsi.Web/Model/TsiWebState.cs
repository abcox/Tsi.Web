...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebState :  IEquatable<TsiWebState>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebState" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebState(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        {
            return this.Equals(input as TsiWebState);
        }

        /// <summary>
        /// Returns true if TsiWebState instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebState input)
        {
            if (input == null)
                return false;
