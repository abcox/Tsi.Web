...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebSymptom :  IEquatable<TsiWebSymptom>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebSymptom" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebSymptom(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        {
            return this.Equals(input as TsiWebSymptom);
        }

        /// <summary>
        /// Returns true if TsiWebSymptom instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebSymptom to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebSymptom input)
        {
            if (input == null)
                return false;
