...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebSystemType :  IEquatable<TsiWebSystemType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebSystemType" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebSystemType(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebSystemType {\n");
        ...
        {
            return this.Equals(input as TsiWebSystemType);
        }

        /// <summary>
        /// Returns true if TsiWebSystemType instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebSystemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebSystemType input)
        {
            if (input == null)
                return false;
