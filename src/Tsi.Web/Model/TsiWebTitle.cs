...
namespace Tsi.Web.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TsiWebTitle :  IEquatable<TsiWebTitle>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebTitle" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        /// <param name="isSystemEntry">isSystemEntry.</param>
        /// <param name="isSystemDefault">isSystemDefault.</param>
        public TsiWebTitle(int? id = default(int?), string value = default(string), bool? isSystemEntry = default(bool?), bool? isSystemDefault = default(bool?))
        {
            this.Id = id;
            this.Value = value;
        ...
        {
            return this.Equals(input as TsiWebTitle);
        }

        /// <summary>
        /// Returns true if TsiWebTitle instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebTitle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebTitle input)
        {
            if (input == null)
                return false;
