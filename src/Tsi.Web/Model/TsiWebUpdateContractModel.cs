...
{
    /// <summary>
    /// TsiWebUpdateContractModel
    /// </summary>
    [DataContract]
    public partial class TsiWebUpdateContractModel :  IEquatable<TsiWebUpdateContractModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebUpdateContractModel" /> class.
        /// </summary>
        /// <param name="calculateContractPrice">calculateContractPrice.</param>
        /// <param name="allowContractPriceOverrideWhenPriceChanges">allowContractPriceOverrideWhenPriceChanges.</param>
        /// <param name="description">description.</param>
        /// <param name="limitServiceOrdersToItemsCovered">limitServiceOrdersToItemsCovered.</param>
        ...
        /// <summary>
        /// Gets or Sets CalculateContractPrice
        /// </summary>
        [DataMember(Name="CalculateContractPrice", EmitDefaultValue=false)]
        public bool? CalculateContractPrice { get; set; }

        /// <summary>
        /// Gets or Sets AllowContractPriceOverrideWhenPriceChanges
        /// </summary>
        [DataMember(Name="AllowContractPriceOverrideWhenPriceChanges", EmitDefaultValue=false)]
        public bool? AllowContractPriceOverrideWhenPriceChanges { get; set; }
        ...
        /// <summary>
        /// Gets or Sets LimitServiceOrdersToItemsCovered
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebUpdateContractModel {\n");
            sb.Append("  CalculateContractPrice: ").Append(CalculateContractPrice).Append("\n");
            sb.Append("  AllowContractPriceOverrideWhenPriceChanges: ").Append(AllowContractPriceOverrideWhenPriceChanges).Append("\n");
        ...
        {
            return this.Equals(input as TsiWebUpdateContractModel);
        }

        /// <summary>
        /// Returns true if TsiWebUpdateContractModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebUpdateContractModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebUpdateContractModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CalculateContractPrice == input.CalculateContractPrice ||
                    (this.CalculateContractPrice != null &&
                    this.CalculateContractPrice.Equals(input.CalculateContractPrice))
                ) && 
                (
                    this.AllowContractPriceOverrideWhenPriceChanges == input.AllowContractPriceOverrideWhenPriceChanges ||
                    (this.AllowContractPriceOverrideWhenPriceChanges != null &&
                    this.AllowContractPriceOverrideWhenPriceChanges.Equals(input.AllowContractPriceOverrideWhenPriceChanges))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.CalculateContractPrice != null)
                    hashCode = hashCode * 59 + this.CalculateContractPrice.GetHashCode();
                if (this.AllowContractPriceOverrideWhenPriceChanges != null)
                    hashCode = hashCode * 59 + this.AllowContractPriceOverrideWhenPriceChanges.GetHashCode();
