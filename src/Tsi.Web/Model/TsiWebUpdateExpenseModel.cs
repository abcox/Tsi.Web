...
{
    /// <summary>
    /// TsiWebUpdateExpenseModel
    /// </summary>
    [DataContract]
    public partial class TsiWebUpdateExpenseModel :  IEquatable<TsiWebUpdateExpenseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebUpdateExpenseModel" /> class.
        /// </summary>
        ...
        public TsiWebUpdateExpenseModel(int? expenseTypeNumber = default(int?), string expenseType = default(string), int? repNumber = default(int?), int? expensePaymentTypeNumber = default(int?), string expensePaymentType = default(string), DateTime? expenseDateTime = default(DateTime?), double? expenseAmount = default(double?), double? odometerStart = default(double?), double? odometerEnd = default(double?), double? distance = default(double?), string comments = default(string), bool? billable = default(bool?), bool? reimbursable = default(bool?), string distanceType = default(string), string acceptanceStatus = default(string), string rejectedReason = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebUpdateExpenseModel {\n");
        ...
        {
            return this.Equals(input as TsiWebUpdateExpenseModel);
        }

        /// <summary>
        /// Returns true if TsiWebUpdateExpenseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebUpdateExpenseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebUpdateExpenseModel input)
        {
            if (input == null)
                return false;
