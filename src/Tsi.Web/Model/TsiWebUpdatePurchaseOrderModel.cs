...
{
    /// <summary>
    /// TsiWebUpdatePurchaseOrderModel
    /// </summary>
    [DataContract]
    public partial class TsiWebUpdatePurchaseOrderModel :  IEquatable<TsiWebUpdatePurchaseOrderModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebUpdatePurchaseOrderModel" /> class.
        /// </summary>
        /// <param name="purchaseOrderCostToUseType">purchaseOrderCostToUseType.</param>
        ...
        /// <summary>
        /// Gets or Sets PurchaseOrderCostToUseType
        /// </summary>
        [DataMember(Name="PurchaseOrderCostToUseType", EmitDefaultValue=false)]
        public string PurchaseOrderCostToUseType { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebUpdatePurchaseOrderModel {\n");
            sb.Append("  PurchaseOrderCostToUseType: ").Append(PurchaseOrderCostToUseType).Append("\n");
        ...
        {
            return this.Equals(input as TsiWebUpdatePurchaseOrderModel);
        }

        /// <summary>
        /// Returns true if TsiWebUpdatePurchaseOrderModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebUpdatePurchaseOrderModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebUpdatePurchaseOrderModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.PurchaseOrderCostToUseType == input.PurchaseOrderCostToUseType ||
                    (this.PurchaseOrderCostToUseType != null &&
                    this.PurchaseOrderCostToUseType.Equals(input.PurchaseOrderCostToUseType))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.PurchaseOrderCostToUseType != null)
                    hashCode = hashCode * 59 + this.PurchaseOrderCostToUseType.GetHashCode();
