...
{
    /// <summary>
    /// TsiWebUpdateServiceOrderItemServicedModel
    /// </summary>
    [DataContract]
    public partial class TsiWebUpdateServiceOrderItemServicedModel :  IEquatable<TsiWebUpdateServiceOrderItemServicedModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebUpdateServiceOrderItemServicedModel" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebUpdateServiceOrderItemServicedModel {\n");
        ...
        {
            return this.Equals(input as TsiWebUpdateServiceOrderItemServicedModel);
        }

        /// <summary>
        /// Returns true if TsiWebUpdateServiceOrderItemServicedModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebUpdateServiceOrderItemServicedModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebUpdateServiceOrderItemServicedModel input)
        {
            if (input == null)
                return false;
