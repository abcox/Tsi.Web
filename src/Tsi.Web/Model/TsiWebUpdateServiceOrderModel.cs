...
{
    /// <summary>
    /// TsiWebUpdateServiceOrderModel
    /// </summary>
    [DataContract]
    public partial class TsiWebUpdateServiceOrderModel :  IEquatable<TsiWebUpdateServiceOrderModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebUpdateServiceOrderModel" /> class.
        /// </summary>
        ...
        /// <param name="completeOpenTasks">completeOpenTasks.</param>
        ...
        public TsiWebUpdateServiceOrderModel(string discountType = default(string), double? discountPercent = default(double?), double? discountAmount = default(double?), double? discountSellForPrice = default(double?), double? discountMarginPercent = default(double?), bool? completeOpenTasks = default(bool?), int? contactNumber = default(int?), int? technicianAssigned = default(int?), int? estimatedHours = default(int?), int? estimatedMinutes = default(int?), int? callBackCount = default(int?), int? repToCredit = default(int?), int? contractNumber = default(int?), int? takenBy = default(int?), int? dispatchBoardNumber = default(int?), int? payMethodsId = default(int?), int? severity = default(int?), string alternatePhoneNumber = default(string), string alternatePhoneLocation = default(string), string alternateContactEmailAddress = default(string), string alternateContactPhoneNumber = default(string), string alternateContactPhoneLocation = default(string), string briefDescription = default(string), string reference = default(string), string priority = default(string), string status = default(string), string serviceOrderType = default(string), string system = default(string), string workRequested = default(string), string workPerformed = default(string), string paymentMethod = default(string), string shippingMethod = default(string), string internalComments = default(string), string directionsToLocation = default(string), string customerPurchaseOrder = default(string), string verifiedBy = default(string), string serviceZone = default(string), string requestedBy = default(string), string tagNumber = default(string), string loanAgreement = default(string), string debitCreditMemo = default(string), string invoiceTerms = default(string), string freightTerms = default(string), string salesTaxCode = default(string), DateTime? dateTimeReceived = default(DateTime?), SystemNullableTsiWebSplitDateTime dateTimeRequested = default(SystemNullableTsiWebSplitDateTime), SystemNullableTsiWebOptionalDateTime dateTimeOpened = default(SystemNullableTsiWebOptionalDateTime), SystemNullableTsiWebOptionalDateTime dateTimeClosed = default(SystemNullableTsiWebOptionalDateTime), SystemNullableTsiWebOptionalDateTime verifiedDate = default(SystemNullableTsiWebOptionalDateTime), bool? resolvedOnPhone = default(bool?), double? bidPrice = default(double?), double? tradeIn = default(double?), double? deposit = default(double?), double? freight = default(double?), string billToAddressType = default(string), int? billToAddressAccountNumber = default(int?), TsiWebAlternateAddress billTo = default(TsiWebAlternateAddress), string shipToAddressType = default(string), int? shipToAddressAccountNumber = default(int?), TsiWebAlternateAddress shipTo = default(TsiWebAlternateAddress), bool? useAlternateShipToTaxCode = default(bool?), bool? canReassignToHourlyUsageContractAlreadyInvoiced = default(bool?), bool? canUpdateContractMeterReadingToServiceOrderReading = default(bool?), bool? allowInactiveContract = default(bool?), bool? allowFutureContract = default(bool?), bool? allowContractNoRemaining = default(bool?), bool? useContractDefaultTech = default(bool?), bool? displayOnCustomerPortal = default(bool?))
        {
            ...
            this.CompleteOpenTasks = completeOpenTasks;
        ...
        /// <summary>
        /// Gets or Sets CompleteOpenTasks
        /// </summary>
        [DataMember(Name="CompleteOpenTasks", EmitDefaultValue=false)]
        public bool? CompleteOpenTasks { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebUpdateServiceOrderModel {\n");
            ...
            sb.Append("  CompleteOpenTasks: ").Append(CompleteOpenTasks).Append("\n");
        ...
        {
            return this.Equals(input as TsiWebUpdateServiceOrderModel);
        }

        /// <summary>
        /// Returns true if TsiWebUpdateServiceOrderModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebUpdateServiceOrderModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebUpdateServiceOrderModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CompleteOpenTasks == input.CompleteOpenTasks ||
                    (this.CompleteOpenTasks != null &&
                    this.CompleteOpenTasks.Equals(input.CompleteOpenTasks))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CompleteOpenTasks != null)
                    hashCode = hashCode * 59 + this.CompleteOpenTasks.GetHashCode();
