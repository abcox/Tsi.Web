...
{
    /// <summary>
    /// TsiWebUpdateServiceOrderNonStockPartsUsedModel
    /// </summary>
    [DataContract]
    public partial class TsiWebUpdateServiceOrderNonStockPartsUsedModel :  IEquatable<TsiWebUpdateServiceOrderNonStockPartsUsedModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebUpdateServiceOrderNonStockPartsUsedModel" /> class.
        /// </summary>
        ...
        public TsiWebUpdateServiceOrderNonStockPartsUsedModel(int? lineNumber = default(int?), string itemDescription = default(string), bool? taxable = default(bool?), bool? subjectToProviderTax = default(bool?), bool? isSerialized = default(bool?), bool? printOnInvoice = default(bool?), bool? underContract = default(bool?), double? sellingPrice = default(double?), double? cost = default(double?), bool? useThisCostWhenOrdering = default(bool?), double? quantity = default(double?), int? serviceOrderItemsServicedNumber = default(int?), string memo = default(string), SystemNullableTsiWebOptionalDateTime orderByDate = default(SystemNullableTsiWebOptionalDateTime), int? projectPhaseNumber = default(int?), string installLocation = default(string), bool? allowPriceLessThanCost = default(bool?), bool? allowQuantityLessThanOrdered = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebUpdateServiceOrderNonStockPartsUsedModel {\n");
        ...
        {
            return this.Equals(input as TsiWebUpdateServiceOrderNonStockPartsUsedModel);
        }

        /// <summary>
        /// Returns true if TsiWebUpdateServiceOrderNonStockPartsUsedModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebUpdateServiceOrderNonStockPartsUsedModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebUpdateServiceOrderNonStockPartsUsedModel input)
        {
            if (input == null)
                return false;
