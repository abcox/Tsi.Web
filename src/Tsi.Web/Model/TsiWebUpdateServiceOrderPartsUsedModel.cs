...
{
    /// <summary>
    /// TsiWebUpdateServiceOrderPartsUsedModel
    /// </summary>
    [DataContract]
    public partial class TsiWebUpdateServiceOrderPartsUsedModel :  IEquatable<TsiWebUpdateServiceOrderPartsUsedModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebUpdateServiceOrderPartsUsedModel" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebUpdateServiceOrderPartsUsedModel {\n");
        ...
        {
            return this.Equals(input as TsiWebUpdateServiceOrderPartsUsedModel);
        }

        /// <summary>
        /// Returns true if TsiWebUpdateServiceOrderPartsUsedModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebUpdateServiceOrderPartsUsedModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebUpdateServiceOrderPartsUsedModel input)
        {
            if (input == null)
                return false;
