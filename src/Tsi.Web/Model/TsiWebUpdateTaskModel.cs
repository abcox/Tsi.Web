...
{
    /// <summary>
    /// TsiWebUpdateTaskModel
    /// </summary>
    [DataContract]
    public partial class TsiWebUpdateTaskModel :  IEquatable<TsiWebUpdateTaskModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebUpdateTaskModel" /> class.
        /// </summary>
        /// <param name="scheduleConflictedTask">scheduleConflictedTask.</param>
        /// <param name="canUpdateOtherRepTask">canUpdateOtherRepTask.</param>
        ...
        public TsiWebUpdateTaskModel(bool? scheduleConflictedTask = default(bool?), bool? canUpdateOtherRepTask = default(bool?), string comment = default(string), int? accountNumber = default(int?), int? contactNumber = default(int?), int? scheduledForRepNumber = default(int?), int? scheduledByRepNumber = default(int?), int? serviceOrderNumber = default(int?), int? serviceOrderTemplateNumber = default(int?), int? quoteNumber = default(int?), int? opportunityNumber = default(int?), int? projectNumber = default(int?), int? projectPhaseNumber = default(int?), int? projectSubPhaseAssignmentNumber = default(int?), DateTime? startDate = default(DateTime?), DateTime? startTime = default(DateTime?), DateTime? endDate = default(DateTime?), DateTime? endTime = default(DateTime?), string action = default(string), string type = default(string), DateTime? dateScheduled = default(DateTime?), int? priorityNumber = default(int?), string priority = default(string), bool? hasAlarm = default(bool?), DateTime? alarmDateTime = default(DateTime?), int? alarmReminderQuantity = default(int?), string alarmReminderInterval = default(string), bool? isCompleted = default(bool?), bool? isPrivate = default(bool?), string resourceName = default(string), bool? isGlobalTask = default(bool?), bool? isAppointment = default(bool?), string subject = default(string), string location = default(string), DateTime? dueDate = default(DateTime?), DateTime? dueTime = default(DateTime?))
        {
            this.ScheduleConflictedTask = scheduleConflictedTask;
            this.CanUpdateOtherRepTask = canUpdateOtherRepTask;
        ...
        /// <summary>
        /// Gets or Sets CanUpdateOtherRepTask
        /// </summary>
        [DataMember(Name="CanUpdateOtherRepTask", EmitDefaultValue=false)]
        public bool? CanUpdateOtherRepTask { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebUpdateTaskModel {\n");
            sb.Append("  ScheduleConflictedTask: ").Append(ScheduleConflictedTask).Append("\n");
            sb.Append("  CanUpdateOtherRepTask: ").Append(CanUpdateOtherRepTask).Append("\n");
        ...
        {
            return this.Equals(input as TsiWebUpdateTaskModel);
        }

        /// <summary>
        /// Returns true if TsiWebUpdateTaskModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebUpdateTaskModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebUpdateTaskModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CanUpdateOtherRepTask == input.CanUpdateOtherRepTask ||
                    (this.CanUpdateOtherRepTask != null &&
                    this.CanUpdateOtherRepTask.Equals(input.CanUpdateOtherRepTask))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CanUpdateOtherRepTask != null)
                    hashCode = hashCode * 59 + this.CanUpdateOtherRepTask.GetHashCode();
