...
{
    /// <summary>
    /// TsiWebUpdateTimeSlipModel
    /// </summary>
    [DataContract]
    public partial class TsiWebUpdateTimeSlipModel :  IEquatable<TsiWebUpdateTimeSlipModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TsiWebUpdateTimeSlipModel" /> class.
        /// </summary>
        ...
        /// <param name="rejectedReasonStatus">rejectedReasonStatus.</param>
        public TsiWebUpdateTimeSlipModel(string billingOption = default(string), string logReason = default(string), int? techAssigned = default(int?), string logComment = default(string), DateTime? startDateTime = default(DateTime?), DateTime? endDateTime = default(DateTime?), string internalComments = default(string), int? deductHours = default(int?), int? deductMinutes = default(int?), bool? creditUtilizationTime = default(bool?), string acceptanceStatus = default(string), string rejectedReasonStatus = default(string))
        {
            ...
            this.RejectedReasonStatus = rejectedReasonStatus;
        }
        ...
        /// <summary>
        /// Gets or Sets RejectedReasonStatus
        /// </summary>
        [DataMember(Name="RejectedReasonStatus", EmitDefaultValue=false)]
        public string RejectedReasonStatus { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TsiWebUpdateTimeSlipModel {\n");
            ...
            sb.Append("  RejectedReasonStatus: ").Append(RejectedReasonStatus).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TsiWebUpdateTimeSlipModel);
        }

        /// <summary>
        /// Returns true if TsiWebUpdateTimeSlipModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TsiWebUpdateTimeSlipModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TsiWebUpdateTimeSlipModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RejectedReasonStatus == input.RejectedReasonStatus ||
                    (this.RejectedReasonStatus != null &&
                    this.RejectedReasonStatus.Equals(input.RejectedReasonStatus))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RejectedReasonStatus != null)
                    hashCode = hashCode * 59 + this.RejectedReasonStatus.GetHashCode();
                return hashCode;
            }
        }
